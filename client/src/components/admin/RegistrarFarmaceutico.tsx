...
interface RegistrarFarmaceuticoProps {
    token: string;
}

export function RegistrarFarmaceutico({ token }: RegistrarFarmaceuticoProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({
                ...
                description: "El farmacéutico ha sido registrado correctamente.",
            })
            setFormData({
                dni: '',
                nombre: '',
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Registrar Farmacéutico</CardTitle>
            </CardHeader>
            <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full" disabled={isLoading}>
                        {isLoading ? 'Registrando...' : 'Registrar Farmacéutico'}
                    </Button>
                </form>
            </CardContent>
        </Card>
